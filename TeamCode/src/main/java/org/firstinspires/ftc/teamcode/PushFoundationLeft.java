...
@Autonomous(name = "FoundationLeft", group="Autonomous")
public class PushFoundationLeft extends BaseAutonomousOpMode<TeamRobot> {
    public PushFoundationLeft() {
        super(new TeamRobot());
    }
    ...
    public void teamRun() {
        try {
            ...
            robot.startStopping().waitUntilFinished();
            robot.startTurningLeft(45).waitUntilFinished();
            robot.startStopping().waitUntilFinished();
